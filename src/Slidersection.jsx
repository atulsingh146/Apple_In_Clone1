...
import "swiper/css";
import "swiper/css/navigation"; // ✅ If you use navigation arrows later
        ...
        {images.map((src, idx) => (
          <SwiperSlide key={idx}>
            <div className="relative w-full" style={{ aspectRatio: "16 / 9" }}>
              ...
              />
              <div className="absolute bottom-0 left-0 w-full bg-black/40 flex items-center justify-center p-4">
                <p className="text-white font-semibold text-lg">Watch on Apple TV+</p>
              </div>
            </div>
          </SwiperSlide>
        ))}
