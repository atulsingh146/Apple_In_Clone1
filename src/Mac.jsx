...
import macImage from './assets/mac_second.png'; // Adjust path if needed
  ...
  return (
    <div className="min-h-screen flex flex-col items-center text-center p-6 space-y-2 bg-custom-gradient">
      ...
      <h3 className="text-xl text-gray-700">
        Sky blue colour. <br /> Sky high performance with M4.
      </h3>
      ...
      <img src={macImage} className="h-64 object-contain" alt="mac" />
